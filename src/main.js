...
const policyUz = {
  ...
  sections: [
    ...
    { title: '11. Bolalar maxfiyligi', paragraphs: ["Paylog 13 yoshdan kichik foydalanuvchilar uchun mo'ljallanmagan.", "Agar bunday ma'lumot tasodifan yig'ilgan bo'lsa, murojaat asosida o'chiriladi."] },
...
const policyRu = {
  ...
  sections: [
    ...
    { title: '11. Конфиденциальность детей', paragraphs: ['Paylog не предназначен для пользователей младше 13 лет.', 'Если такие данные были собраны случайно, они будут удалены по обращению.'] },
...
const policyEn = {
  ...
  sections: [
    ...
    { title: "11. Children's privacy", paragraphs: ['Paylog is not intended for users under 13 years of age.', 'If such information is collected accidentally, it will be deleted upon request.'] },
